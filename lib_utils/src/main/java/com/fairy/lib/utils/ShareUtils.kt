...
class ShareUtils {
     ...
     *
     */
    fun init(context: Context, shareName: String) {
    ...
    fun putObject(key: String, obj: Any): ShareUtils {
        editor.putString(key, obj.toJson())
        return this
    }
    ...
    fun <T> getObject(key: String, clazz: Class<T>): T? {
        return sp.getString(key, null).fromJson(clazz)
    }
    ...
    fun <T> getObject(key: String, typeOfT: Type): T? {
        return sp.getString(key, null).fromJson(typeOfT)
    }
